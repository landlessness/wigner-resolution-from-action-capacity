...
\label{eq:Wtheta}
\end{equation}
Convolving $W$ with the kernel $K_\theta$ of a single quantum blob $a_\theta$ lifts it to Planck's quantum of action and yields a non-negative function~\cite{cartwright1976,degosson2005bullsci,degossonluef2009irruption,cordero2018}.

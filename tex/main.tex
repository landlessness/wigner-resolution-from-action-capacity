...
%===============================================================================
Zurek also located the area scale $a \sim \hbar \times (\hbar / A)$~\cite{zurek2001,zurek2003decoherence} of the chessboard structure in the compass state (Fig.~\ref{fig:cat}, column 1). We identify its coordinate-free form as the resolution cell $a$. It is the ellipse with semi-axes $\delta x, \delta p$ (Figs.~\ref{fig:principal_blobs},~\ref{fig:quantum_blobs}) and action
\begin{equation}
...
and circumscribes $a$, touching each, so no $h/2$ smoothing of this
